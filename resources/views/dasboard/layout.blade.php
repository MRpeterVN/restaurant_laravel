...
@endif
    ...
    <div id="sidebar-collapse" class="col-sm-3 col-lg-2 sidebar">
        ...
        <ul class="nav menu">
            ...
            <li class="active"><a href="{{ route('dashboard.index') }}"><em class="fa fa-dashboard">&nbsp;</em> Thống Kê</a></li>
            <li><a href="{{ route('dashboard.list') }}"><em class="fa fa-table">&nbsp;</em> Quản lý món ăn </a></li>

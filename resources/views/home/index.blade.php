...
<section class="food_section layout_padding-bottom">
    <div class="container">
        ...
        <ul class="filters_menu">
            ...
            <li data-filter=".option_1">Option 1</li>
            <li data-filter=".option_2">Option 2</li>
            <li data-filter=".option_3">Option 3</li>
            <li data-filter=".option_4">Option 4</li>
        </ul>

        <div class="filters-content">
            <div class="row grid">
                @foreach ($monAn as $monan)
                <div class="col-sm-6 col-lg-4 all {{ $monan->phan_loai }}">
                    <div class="box">
                        <div>
                            <div class="img-box">
                                <img class="wrapper" src="{{ asset('images/'.$monan->anh) }}"
                                    alt="{{ $monan->ten_mon }}">
                            </div>
                            <div class="detail-box">
                                <h5>{{ $monan->ten_mon }}</h5>
...
.wrapper {
    ...
    /* hiển thị hình ảnh vừa đủ với kích thước của phần tử */
    background-position: center;
    /* căn giữa hình ảnh theo chiều ngang và dọc */
